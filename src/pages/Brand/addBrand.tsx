...
export const AddBrand: React.FC<AddCategoryProps> = ({ onSave }) => {
  ...
  const handleSubmit = () => {
    ...
    const categories = brandFromStorage ? JSON.parse(brandFromStorage) : [];
    localStorage.setItem("Brands", JSON.stringify([...categories, category]));
  ...
  return (
    <StyledContainer>
      ...
      <StyledInput>
        ...
        <StyledInputFields>
          <StyledInputText variant="body1">Parent Brand</StyledInputText>
          <StyledInputBox
            id="parent-category"
            label=""
            variant="outlined"
