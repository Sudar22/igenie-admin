import { Autocomplete, Button, Card, CardContent, CardMedia, Switch, TextField, Typography, styled } from "@mui/material";
import React, { useEffect, useState } from "react";
import { useAppDispatch, useAppSelector } from "../../redux/hooks/hooks";
import { getAllCategories, saveCategories } from "../../redux/reducers/categorySlice";
...
const [selectedOption, setSelectedOption] = React.useState<{ id: number, name: string } | null>(null);

const handleAutocompleteChange = (event: React.ChangeEvent<{}>, newValue: { id: number, name: string } | null) => {
  setSelectedOption(newValue);
};
const [value, setValue] = React.useState<string | null>(options?.length > 0 ? options[0] : null);
